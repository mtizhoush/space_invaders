...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button, title, title2, bunkers):
...
def create_bunker(ai_settings, screen, bunkers, bunker_number, row_number):
    ...
    bunker.x = bunker_width + 1 * bunker_width * bunker_number
    bunker.rect.x = bunker.x
    bunker.rect.y = bunker.rect.height + 1 * bunker.rect.height * row_number
    bunkers.add(bunker)
